...
<head>
  <meta charset="utf-8">
  <title>Novedades - Optica Salome</title>
      ...
      <div class="container"><!-- container -->
        <div class="row"> <!-- row -->
          <div class="wow zoomIn col-xs-12"> <!-- col-xs-12 -->
            <img class="img-responsive" src="img/blog-image03.jpg" alt="Monturas en Lima"/>  
          </div> <!-- /.col-xs-12-->
            ...
            <div class="blog-date"><!-- blog-date -->
             <p> <span>20</span> Julio 2015</p>
                ...
                <div class="wow zoomIn col-xs-12 col-sm-9 col-md-10">
                  <h1><a href="#">El uso en Lentes de Contacto</a></h1>
                  <div class="icon-holder">
                    <a href="#"><span><i class="flaticon-man494"></i>1 admin</span></a>
                    <a href="#"><span><i class="flaticon-eye128"></i>15 vistas</span></a>
                    <a href="#"><span><i class="flaticon-comments16"></i>13 comentarios</span></a>
            </div><!-- /.icon-holder -->
            <p class="contents">
               Los lentes de contacto son lentes correctores o cosméticos que se ponen en el ojo, concretamente sobre la película lagrimal que cuida y lubrica la córnea. Estos lentes deben cumplir todos los requisitos sanitarios. Su uso es seguro si se hace con las normas adecuadas. Entre las más importantes están el lavado de manos, la lubricación y adecuada limpieza del lente.                  
            </p>
