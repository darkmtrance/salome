...
<head>
  <meta charset="utf-8">
  <title>Tratamientos en Opticas Salome</title>
      ...
      <div class="container"><!-- container -->
        <div class="row"> <!-- row -->
          <div class="wow zoomIn col-xs-12"> <!-- col-xs-12 -->
            <img class="img-responsive" src="img/blog-image02.jpg" alt="Monturas en Lima"/>  
          </div> <!-- /.col-xs-12-->
          <div class="wow zoomIn col-xs-2 col-sm-3 col-md-2"><!-- col-md-2 -->
            <div class="blog-date"><!-- blog-date -->
             <p> <span>20</span> Julio 2015</p>
                  </div>
                </div>
                <div class="wow zoomIn col-xs-12 col-sm-9 col-md-10">
                  <h1><a href="#">Lentes más limpios por más tiempo</a></h1>
                  <div class="icon-holder">
                    <a href="#"><span><i class="flaticon-man494"></i>1 admin</span></a>
                    <a href="#"><span><i class="flaticon-eye128"></i>10 vistas</span></a>
                    <a href="#"><span><i class="flaticon-comments16"></i>8 comentarios</span></a>
            </div><!-- /.icon-holder -->
            <p class="contents">
               El Tratamiento con la más alta tecnología del mercado. Símbolo de distinción en lentes ópticos. Estos lentes repelen el agua, suciedad y sustancias aceitosas haciendo más fácil su limpieza. Gracias a su capa protectora y a su halo azul, lucirá lentes exclusivos, que reducen considerablemente la fatiga visual y son prácticamente invisibles lo cual brinda una apariencia más estética.
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="wow zoomIn col-xs-12 col-sm-6 col-md-3">
            ...
            <ul class="footerblog">
               <li><a href="promocion1.php">Monturas en Lima</a> <p>07 de Agosto 2015</p></li>
