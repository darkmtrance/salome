...
<head>
  <meta charset="utf-8">
  <title>Consejos - Optica Salome</title>
      ...
      <div class="container"><!-- container -->
        <div class="row"> <!-- row -->
          <div class="wow zoomIn col-xs-12"> <!-- col-xs-12 -->
            <img class="img-responsive" src="img/blog-image03.jpg" alt="Opticas en Los Olivos"/>  
          </div> <!-- /.col-xs-12-->
            ...
            <div class="blog-date"><!-- blog-date -->
             <p> <span>20</span> Julio 2015</p>
                ...
                <div class="wow zoomIn col-xs-12 col-sm-9 col-md-10">
                  <h1>El uso en Lentes de Contacto</h1>
                  <div class="icon-holder">
                    <span><i class="flaticon-man494"></i>1 admin</span>
                    <span><i class="flaticon-eye128"></i>15 vistas</span>
                    <span><i class="flaticon-comments16"></i>13 comentarios</span>
            </div><!-- /.icon-holder -->
            <p class="contents">
